...
save_path = os.path.join("/scratch","chawda", "trained_model", "pascal_voc", "faster_rcnn", "vgg16")
...
#loading the model
model = FasterRCNN(backbone, num_classes=20,rpn_anchor_generator= anchor_generator, box_roi_pool=roi_pooler )
