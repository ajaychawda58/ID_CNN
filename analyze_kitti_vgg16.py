...
from transforms import ToTensor, Compose, testTensor, testResize
...
save_path = os.path.join("/scratch","chawda", "trained_model", "kitti", "faster_rcnn", "vgg16")
...
data = test_data(image_directory, transforms=transforms.Compose([testResize((300,300)),testTensor()]))
